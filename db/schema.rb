...
ActiveRecord::Schema.define(version: 2021_08_08_210812) do
  ...
  create_table "user_private_messages", force: :cascade do |t|
    t.bigint "recived_message_id"
    t.bigint "recipient_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recipient_id"], name: "index_user_private_messages_on_recipient_id"
    t.index ["recived_message_id"], name: "index_user_private_messages_on_recived_message_id"
  end
